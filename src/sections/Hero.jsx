...
const Hero = () => {
    return (
        <section className='hero-bg h-[50vh] relative'>
            ...
            <div  className='container mx-auto h-full '>
                <div className='w-1/2 h-full flex flex-col items-start justify-center gap-5 mx-auto'>
                    ...
                    <div className='flex flex-row gap-4 z-20 justify-center items-center'>
                        <a className='z-20 bg-green-500 border-2 border-green-500 text-stone-50 text-xl font-semibold rounded-lg px-3 py-1 flex flex-row items-center gap-1 hover:bg-green-400 hover:border-green-400 transition-all ease-in-out' href="whatsapp">
                             <WhatsappIcon/>
                              Contactar
                        </a>
