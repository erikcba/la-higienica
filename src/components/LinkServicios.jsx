...
const LinkServicios = () => {
    return (
        <div>
            <a href="{link}" target="_blank" rel="noreferrer" className='font-medium flex flex-row items-center justify-center gap-1 text-blue-800 hover:scale-110 transition-all duration-300'>
